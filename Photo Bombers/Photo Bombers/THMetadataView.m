...
- (void)setPhoto:(NSDictionary *)photo {
    ...
    [THPhotoController avatarForPhoto:_photo completion:^(UIImage *image) {
        self.avatarImageView.image = image;
    }];
    
    id likes = self.photo[@"likes"][@"count"];
    id comments = self.photo[@"comments"][@"count"];
    
    NSString *likeString =  [NSString stringWithFormat:@"%@", likes];
    NSString *commentString =  [NSString stringWithFormat:@"%@", comments];
    ...
    [self.commentsButton setTitle:commentString forState:UIControlStateNormal];
