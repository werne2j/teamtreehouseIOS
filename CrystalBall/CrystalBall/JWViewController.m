...
- (void)viewDidLoad
{
    ...
    NSString *soudPath = [[NSBundle mainBundle] pathForResource:@"crystal_ball" ofType:@"mp3"];
    
    NSURL *soundURL = [NSURL fileURLWithPath:soudPath];
    AudioServicesCreateSystemSoundID(CFBridgingRetain(soundURL), &soundEffect);
    
    self.crystalBall = [[JWCrystalBall alloc] init];
